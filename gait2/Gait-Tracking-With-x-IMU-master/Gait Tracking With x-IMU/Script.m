...
close all;
clc;
addpath('C:\Users\harol\OneDrive\Documentos\MiguelMATLAB\gait2\Gait-Tracking-With-x-IMU-master\Gait Tracking With x-IMU\Quaternions');
addpath('C:\Users\harol\OneDrive\Documentos\MiguelMATLAB\gait2\Gait-Tracking-With-x-IMU-master\Gait Tracking With x-IMU\ximu_matlab_library');

% -------------------------------------------------------------------------
% Select dataset (comment in/out)

filePath = 'C:\Users\harol\OneDrive\Documentos\MiguelMATLAB\gait2\Gait-Tracking-With-x-IMU-master\Gait Tracking With x-IMU\Datasets\straightLine';
startTime = 6;
stopTime = 26;
...
x=1;
while length(stationaryEnd) > length(stationaryStart)
   
    stationaryEnd = stationaryEnd(2,:);
